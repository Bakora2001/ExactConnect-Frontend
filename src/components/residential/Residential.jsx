          ...
          <div className="px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {pricingPlans.map((plan, index) => (
                <div 
                  key={index} 
                  className={`rounded-xl shadow-md overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:scale-105 ${
                    plan.popular 
                      ? `${darkMode ? 'border-2 border-purple-500' : 'border-2 border-[#8a4fc2]'} relative` 
                ...
                >
                  ...
                  <div className="p-8">
                    <h3 className={`text-xl font-bold mb-2 ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>{plan.title}</h3>
                    <div className="mb-2">
                      <span className={`text-3xl font-bold ${darkMode ? 'text-purple-400' : 'text-[#8a4fc2]'}`}>{plan.price}</span>
                    </div>
                    {plan.period && (
                    ...
                    <button 
                      className={`w-full py-3 rounded-lg font-semibold transition duration-300 ${
                        plan.isCustom 
                          ? `${darkMode ? 'bg-gray-800 border-2 border-purple-700 text-purple-400 hover:bg-gray-700' : 'bg-white border-2 border-[#8a4fc2] text-[#8a4fc2] hover:bg-purple-50'}` 
                          : `${darkMode ? 'bg-purple-700 hover:bg-purple-800' : 'bg-[#8a4fc2] hover:bg-[#7040a3]'} text-white`
                      }`}
                      onClick={() => {
                        if (plan.isCustom) {
