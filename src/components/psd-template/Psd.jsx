...
const Psd = () => {
  ...
  const categories = [
    ...
    {
      id: 'id-card',
      title: 'Residency ID Card Template',
      icon: '🪪',
      description: 'Customizable ID card templates for various Countries.',
      ...
      >
        <div className="max-w-4xl mx-auto">
          {selectedCategory ? (
            ...
            <div className="text-center py-10 bg-purple-50 ">
              <div className={`text-xl ${darkMode ? 'text-gray-300' : 'text-black-600'}`}>
