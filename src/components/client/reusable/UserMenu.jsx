  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center justify-center p-2 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 text-white"
      >
        <User className="w-10 aspect-square rounded-full " />
      </button>
