...
=======
      ...
      <div className="flex flex-col-reverse lg:flex-row justify-between bg-white p-8 lg:p-16 max-w-screen-xl mx-12 mb-8">
        ...
        <div className="text-gray-800 pt-4 lg:pt-12 flex-row w-full lg:w-1/2">
          ...
          <div className="mb-6 lg:mb-8">
            <h2 className="text-[14px] lg:text-[16px] font-light">
              <span className="block text-left">
                ExactConnect high-performance VPS Hosting redefines
                <br />
                excellence, combining cutting-edge technology with
                <br /> affordability.
              </span>
            </h2>
          </div>
        ...
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
          <img
            src={rdp1}
            alt="RDP"
            className="h-auto pt-4 lg:pt-12 object-contain max-w-full"
          />
        </div>
      </div>
      ...
      <div className="bg-[#F1F0F2] p-8">
        <div className="flex flex-wrap justify-center gap-4 pt-4">
          {/* Flags for various countries */}
          <span className="text-3xl" title="United States">
            🇺🇸
          </span>
          <span className="text-3xl" title="United Kingdom">
            🇬🇧
          </span>
          <span className="text-3xl" title="Canada">
            🇨🇦
          </span>
          <span className="text-3xl" title="Germany">
            🇩🇪
          </span>
          <span className="text-3xl" title="France">
            🇫🇷
          </span>
          <span className="text-3xl" title="Italy">
            🇮🇹
          </span>
          <span className="text-3xl" title="Spain">
            🇪🇸
          </span>
          <span className="text-3xl" title="Australia">
            🇦🇺
          </span>
          <span className="text-3xl" title="Netherlands">
            🇳🇱
          </span>
          <span className="text-3xl" title="Sweden">
            🇸🇪
          </span>
          <span className="text-3xl" title="Switzerland">
            🇨🇭
          </span>
          <span className="text-3xl" title="Belgium">
            🇧🇪
          </span>
        </div>
        <h3 className="text-2xl font-light text-center mt-16 mb-4">
          Supports Over 15+ Countries with Affordable Pricing that fits Your
          Needs
        </h3>
        {/* New Buttons Section */}
        <div className="bg-[#F1F0F2] p-4 mb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="bg-white w-[270px] h-[650px] p-8 rounded-lg shadow-lg">
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <strong>IP Address:</strong> 1 IPv4
                  </li>
                  <li>
