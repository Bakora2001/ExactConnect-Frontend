...
// // RDP data with different countries and specifications
// const rdpData = [
//   {
//     id: 1,
//     countryCode: 'US',
...
//     >
//       {/* Header Section with Prominent Contact Button */}
//       <motion.div 
...
//       {/* Country Selection */}
//       <motion.div className="mb-8" variants={itemVariants} id="rdp-plans">
//         <div className="flex items-center mb-4">
//           <Globe className="h-5 w-5 mr-2 text-purple-600" />
//           <h2 className="text-xl font-semibold">Select Server Location</h2>
//         </div>
...
//       {/* Payment Dialog - Changed to center modal instead of side sheet */}
...
//           <SheetHeader>
//             <SheetTitle className="text-xl">Complete Your Purchase</SheetTitle>
//             <SheetDescription>
//               {selectedRdp && (
//                 <div className="mb-2">
