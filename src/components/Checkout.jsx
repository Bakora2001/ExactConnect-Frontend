  ...
  return (
    <div className="flex min-h-screen bg-gray-100 p-6">
      <div className="w-full lg:w-3/4 mx-auto bg-white shadow-lg rounded-lg p-6">
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">Review & Checkout</h2>
          ...
          <div className="w-full md:w-2/3 p-4">
            <div className="bg-white border border-gray-300 rounded-lg p-4">
              <div className="flex justify-between items-center border-b pb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800">Price/Cycle</h3>
              </div>
              <div className="py-4 flex justify-between items-start">
                <div>
                  <div className="flex items-center">
                    <h4 className="text-gray-800 font-medium">SSD-bKVM 512</h4>
                    <FaEdit className="ml-2 text-blue-500 cursor-pointer" onClick={openEditModal} />
                  </div>
                  ...
                  <ul className="text-sm text-gray-600 mt-2 space-y-1">
                    ...
                    <li>
                      Backup: {backup ? 'Auto backup (we are trying our best to keep your data safe)' : 'No backup'}
                    </li>
                  </ul>
                </div>
                <div className="text-right">
                  <div className="flex items-center justify-end">
                    <p className="text-lg font-semibold text-gray-800">$14.00 USD</p>
                    <FaTrashAlt className="ml-2 text-red-500 cursor-pointer" onClick={openRemoveModal} />
                  </div>
      ...
      {isRemoveModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg relative">
            <MdClose className="absolute top-2 right-2 text-gray-500 cursor-pointer" onClick={closeRemoveModal} />
            <h3 className="text-lg font-semibold mb-4">Confirm Removal</h3>
            <p>Are you sure you want to remove this item?</p>
            <div className="mt-4 flex justify-end space-x-4">
              <button className="bg-gray-200 text-gray-800 px-4 py-2 rounded" onClick={closeRemoveModal}>Cancel</button>
      ...
      {isEditModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg relative">
            <MdClose className="absolute top-2 right-2 text-gray-500 cursor-pointer" onClick={closeEditModal} />
            <h3 className="text-lg font-semibold mb-4">Confirm Edit</h3>
            <p>Do you want to edit the product configuration?</p>
            <div className="mt-4 flex justify-end space-x-4">
              <button className="bg-gray-200 text-gray-800 px-4 py-2 rounded" onClick={closeEditModal}>Cancel</button>
      ...
      {isCheckoutModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg relative">
            <MdClose className="absolute top-2 right-2 text-gray-500 cursor-pointer" onClick={closeCheckoutModal} />
            ...
            <div className="mt-4 flex justify-end space-x-4">
              <button className="bg-gray-200 text-gray-800 px-4 py-2 rounded" onClick={closeCheckoutModal}>Cancel</button>
              <button className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Confirm Checkout</button>
            </div>
          </div>
        </div>
      )}
