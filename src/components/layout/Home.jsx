    ...
    <div>
      {
        isLoading ? (
          ...
          className={`font-sans ${darkMode ? 'bg-[#131312] text-white' : 'bg-white text-black'
            }`}
        >
          <div className={`h-auto sm:h-[655px] flex flex-col items-center mb-10 ${darkMode ? 'bg-[#131312]' : 'bg-purple-700'} text-white relative`}>
            {/* NavBar */}
