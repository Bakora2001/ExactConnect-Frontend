  ...
  return (
    <div>
      {isLoading ? (
        ...
        <div
          className={`font-sans ${
            darkMode ? 'bg-[#111827] text-white' : 'bg-[#7C25BA] text-white'
          }`}
        >
          ...
          >
            ...
            {/* Main Content */}
            <main className="relative  flex flex-col md:flex-row gap-8 sm:gap-24 text-center md:text-left">
              <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-[1rem] md:px-[3rem] sm:px-12 gap-10 md:gap-16 pb-16">
                <div className="md:w-1/2 text-center md:text-left animate-slideInLeft">
                  <p className="text-4xl sm:text-4xl font-[200px] font-sans font-bold leading-tight mb-6 text-white">
                    {typedText}
                  </p>
          ...
          <section
            className={`text-center py-6 px-4 sm:px-8 animate-fadeIn ${
          ...
          >
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-bold mb-2 animate-fadeIn">
                Residential Proxies
              </h3>
              ...
              <div className="flex-1 border-b sm:border-b-0 sm:border-r-2 border-gray-400 pb-6 sm:pb-0 sm:pr-8 animate-slideInLeft">
                <div className="text-left">
                  ...
                  <ul className="list-disc list-inside font-light text-[14px] sm:text-[16px] space-y-4">
                    ...
                    >
                      Exact IP for Online Accounts Creation
                    </li>
                    <li
                      className="animate-fadeIn"
                      style={{ animationDelay: '0.2s' }}
                    >
                      Supports Guaranteed 100% Online Mask Identification
                    </li>
                    <li
                      className="animate-fadeIn"
                      style={{ animationDelay: '0.3s' }}
                    >
                      Very Affordable pricing for Daily and Monthly Residential
                      IPs
                    </li>
                    <li
                      className="animate-fadeIn"
                ...
                <div className="text-left">
                  ...
                  <ul className="list-disc list-inside font-light text-[14px] sm:text-[16px] space-y-4">
                    <li
                      ...
                      style={{ animationDelay: '0.1s' }}
                    >
                      Oneforma Account Creation (Any Locale)
                    </li>
                    <li
                      className="animate-fadeIn"
                      style={{ animationDelay: '0.2s' }}
                    ...
                    <li
                      ...
                      style={{ animationDelay: '0.3s' }}
                    >
                      Crowdsourcing Platforms (Outlier, Appen, Clickworker,
                      Oneforma, Echolabs, Telus AI)
                    </li>
                    <li
                      className="animate-fadeIn"
                      style={{ animationDelay: '0.4s' }}
          ...
          {/* VPS Server Section */}
          <section
            className={`text-center py-8 px-4 sm:px-16 lg:px-24 w-full animate-fadeIn ${
          ...
          <section className="bg-white dark:bg-[#111827] pt-8 pb-4   animate-fadeIn">
            {/* Why Choose Our Services Section */}
            <h2 className="text-2xl sm:text-3xl text-black font-semibold text-center pb-3 font-italic animate-slideInUp  dark:text-white">
              Are You In Need of Real Non-VOIP Numbers For Your Account
              Verification?
            </h2>
            <h4 className="text-2px sm:text-2px text-black pb-4 font-light text-center font-italic animate-fadeInUp dark:text-white">
          ...
          <section
            className={`py-8 px-4 sm:px-8 md:px-16 lg:px-24 animate-fadeIn ${
            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col lg:flex-row items-center gap-8">
                ...
                <div className="w-full lg:w-1/2 animate-slideInLeft">
                  ...
                  >
                    ...
                    <div className="mt-8 text-center">
                      <button
                        className={`px-6 py-2 rounded-lg shadow-md font-medium transition-all duration-300 transform hover:scale-105 ${
                          darkMode
                ...
                <div className="w-full lg:w-1/2 flex flex-col items-center justify-center animate-slideInRight">
                  ...
                  >
                    <h4 className="text-lg font-semibold mb-3 border-l-4 border-purple-600 pl-3">
                      Why Choose Our Non-VOIP Numbers?
                    </h4>
                    <p className="text-sm md:text-base leading-relaxed">
                      Our genuine Non-VOIP numbers ensure reliable verification
                      for all major platforms and services. With instant
                      delivery and 24/7 support, we guarantee successful
                      verification every time. Perfect for social media, payment
