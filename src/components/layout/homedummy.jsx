    ...
    <div>
      {isLoading ? (
        ...
        >
          ...
          {/* VPS Server Section */}
          <section className={`text-center py-12 px-4 sm:px-8 lg:px-12 w-full animate-fadeIn ${
            darkMode ? 'bg-[#111827] text-white' : 'bg-white text-black'
          }`}>
            <div>
              <h3 className="text-xl sm:text-2xl font-bold mb-3">RDP Server</h3>
              <div className="border-b-4 sm:border-b-8 border-purple-700 w-12 sm:w-16 mx-auto mb-8 rounded-full animate-fadeIn"></div>
            </div>

            <div className="mx-auto flex flex-col lg:flex-row gap-8 items-center lg:items-start max-w-7xl">
              {/* Text Section */}
              <div className="text-left w-full lg:w-1/2 px-4 sm:px-8 lg:px-12 animate-slideInLeft">
                <h4 className="font-medium text-lg sm:text-xl mb-4">
                  Why Our RDP?
                </h4>
                <div className="border-b border-gray-500 w-48 sm:w-56 mb-6"></div>
                <ul className="list-disc list-inside font-light text-base space-y-3 sm:space-y-4">
              ...
              <div className="flex justify-center lg:justify-end w-full lg:w-1/2 animate-slideInRight">
                <img
                  src={server}
                  alt="server-logo"
                  className="max-w-full sm:max-w-md lg:max-w-lg object-contain hover:scale-105 transition-transform duration-500"
                />
              </div>
            </div>
          ...
          {/* PSD Templates Section (Replaced Virtual Credit Card) */}
          <section
            className={`${
          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="border-b-4 border-purple-700 w-24 mx-auto mb-8 rounded-full"></div>
              ...
              <div className="grid lg:grid-cols-2 gap-10 items-center">
                <div className="flex justify-center animate-slideInLeft">
                  <img
                    src={wallet}
                    alt="PSD Templates"
                    className="max-h-[350px] hover:scale-105 transition-transform duration-500"
                  />
                </div>
                <div className="animate-slideInRight">
                  <h4 className="text-xl font-semibold mb-4">Our PSD Template Services</h4>
                  <p className="mb-6 text-base">
                    We OFFER high-quality, cost-effective templates for various identification and verification purposes:
                  </p>
                  <ul className="list-disc space-y-3 pl-6">
                    <li className="animate-fadeIn" style={{animationDelay: "0.1s"}}>Driving License Templates</li>
                    <li className="animate-fadeIn" style={{animationDelay: "0.2s"}}>Utility Bill Templates</li>
                    <li className="animate-fadeIn" style={{animationDelay: "0.3s"}}>Residency ID Card Templates</li>
                    <li className="animate-fadeIn" style={{animationDelay: "0.4s"}}>Passport Templates</li>
                    <li className="animate-fadeIn" style={{animationDelay: "0.5s"}}>24/7 Customization Support</li>
                    <li className="animate-fadeIn" style={{animationDelay: "0.6s"}}>High-Resolution Files</li>
                  </ul>
...
//           <section className={`text-center py-12 px-4 sm:px-8 animate-fadeIn ${
//             darkMode ? 'bg-[#1E293B] text-white' : 'bg-gradient-to-b from-white to-purple-50 text-gray-800'
//           }`}>
//             <section>
//               {/* Why Choose Our Services Section - Enhanced */}
//               <h2 className="text-3xl sm:text-4xl font-bold text-center mb-3 animate-slideInUp">
//                 Why Choose Our Services?
//               </h2>
//               <div className="flex justify-center">
//                 <div className={`h-1 w-20 sm:w-32 rounded-full mb-8 ${
//                   darkMode ? 'bg-gradient-to-r from-purple-500 to-pink-500' : 'bg-gradient-to-r from-purple-600 to-indigo-600'
//                 } animate-fadeIn`}></div>
//               </div>
//               <p className="max-w-3xl mx-auto text-lg mb-12 opacity-90">
//                 We offer premium digital solutions to meet all your online needs with top security and reliability
//               </p>
//             </section>
            
//             {/* Residential Proxies Section - Enhanced */}
//             <div>
//               <h3 className="text-2xl sm:text-3xl font-bold mb-2 animate-fadeIn">Residential Proxies</h3>
//               <div className={`h-1 w-16 sm:w-24 mx-auto mb-8 rounded-full ${
//                 darkMode ? 'bg-gradient-to-r from-purple-500 to-pink-500' : 'bg-gradient-to-r from-purple-600 to-indigo-600'
//               } animate-fadeIn`}></div>
//             </div>

//             <div className="max-w-6xl mx-auto flex flex-col sm:flex-row gap-8 sm:gap-12">
//               {/* Benefits Section - Enhanced */}
//               <div className="flex-1 border-b sm:border-b-0 sm:border-r-2 border-gray-400/30 pb-6 sm:pb-0 sm:pr-8 animate-slideInLeft">
//                 <div className="text-left">
//                   <h4 className={`font-medium text-xl ml-6 sm:ml-12 ${
//                     darkMode ? 'text-purple-400' : 'text-purple-700'
//                   }`}>
//                     Benefits
//                   </h4>
//                   <div className="border-b border-gray-500/50 w-24 sm:w-32 ml-6 sm:ml-12 mb-6"></div>
//                   <ul className="list-disc list-inside font-light text-base sm:text-lg space-y-4 ml-6 sm:ml-12">
//                     <li className="animate-fadeIn hover:translate-x-1 transition-transform duration-300" style={{animationDelay: "0.1s"}}>Real IPs from Real devices</li>
//                     <li className="animate-fadeIn hover:translate-x-1 transition-transform duration-300" style={{animationDelay: "0.2s"}}>Exact IP for Online Accounts Creation</li>
//                     <li className="animate-fadeIn hover:translate-x-1 transition-transform duration-300" style={{animationDelay: "0.3s"}}>Supports Guaranteed 100% Online Mask Identification</li>
//                     <li className="animate-fadeIn hover:translate-x-1 transition-transform duration-300" style={{animationDelay: "0.4s"}}>Very Affordable pricing for Daily and Monthly Residential IPs</li>
//                     <li className="animate-fadeIn hover:translate-x-1 transition-transform duration-300" style={{animationDelay: "0.5s"}}>Supports SOCKS5/HTTP</li>
//                     <li className="animate-fadeIn hover:translate-x-1 transition-transform duration-300" style={{animationDelay: "0.6s"}}>Cost-Effective</li>
//                     <li className="animate-fadeIn hover:translate-x-1 transition-transform duration-300" style={{animationDelay: "0.7s"}}>No setup fee</li>
//                   </ul>
//                 </div>
//               </div>

//               {/* Use Case Section - Enhanced */}
//               <div className="flex-1 animate-slideInRight">
//                 <div className="text-left">
//                   <h4 className={`font-medium text-xl ml-6 sm:ml-12 ${
//                     darkMode ? 'text-purple-400' : 'text-purple-700'
...
//                   <div className="border-b border-gray-500/50 w-24 sm:w-32 ml-6 sm:ml-12 mb-6"></div>
//                   <ul className="list-disc list-inside font-light text-base sm:text-lg space-y-4 ml-6 sm:ml-12">
//                     <li className="animate-fadeIn hover:translate-x-1 transition-transform duration-300" style={{animationDelay: "0.1s"}}>Crowdsourcing platforms</li>
//                     <li className="animate-fadeIn hover:translate-x-1 transition-transform duration-300" style={{animationDelay: "0.2s"}}>Data Scraping</li>
//                     <li className="animate-fadeIn hover:translate-x-1 transition-transform duration-300" style={{animationDelay: "0.3s"}}>Crowdsourcing Platforms (Outlier, Appen, Clickworker, Oneforma, Echolabs, Telus AI)</li>
//                     <li className="animate-fadeIn hover:translate-x-1 transition-transform duration-300" style={{animationDelay: "0.4s"}}>Market Research</li>
//                   </ul>
//                 </div>
//               </div>
//             </div>
...
//                       ? 'bg-gradient-to-r from-purple-600 to-purple-800 hover:from-purple-700 hover:to-purple-900' 
//                       : 'bg-gradient-to-r from-purple-600 to-indigo-700 hover:from-purple-700 hover:to-indigo-800'
//                   } text-white px-8 py-3 rounded-full text-base sm:text-lg font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 animate-pulseButton`}>
//                     View Templates
//                   </button>
//                 </Link>
//               </div>
...
//           {/* Non-VOIP Numbers Introduction Section - Enhanced */}
//           <section className={`py-12 px-4 ${
//             darkMode ? 'bg-[#111827] text-white' : 'bg-white text-gray-800'
//           } animate-fadeIn`}>
//             <div className="max-w-5xl mx-auto text-center">
//               <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 animate-slideInUp">
//                 Are You In Need of Real Non-VOIP Numbers For Your Account Verification?
//               </h2>
//               <div className={`h-1 w-16 sm:w-24 mx-auto mb-6 rounded-full ${
//                 darkMode ? 'bg-gradient-to-r from-purple-500 to-pink-500' : 'bg-gradient-to-r from-purple-600 to-indigo-600'
//               } animate-fadeIn`}></div>
//               <h4 className="text-xl sm:text-2xl font-light mb-6 animate-fadeInUp">
//                 We are here to help you with reliable verification solutions
//               </h4>
...
//               }`}>
//                 <p className="text-lg">
//                   Our Non-VOIP numbers ensure successful verification for all major platforms including
//                   <span className="font-semibold"> Google, Facebook, Twitter, Instagram, WhatsApp, Telegram </span>
//                   and many more.
//                 </p>
//               </div>
//             </div>
...
//           {/* Verification Process Section - Completely Redesigned */}
//           <section className={`py-16 px-4 sm:px-8 animate-fadeIn ${
//             darkMode ? 'bg-gradient-to-t from-[#111827] to-[#1E293B] text-white' : 'bg-gradient-to-t from-[#f3f4f6] to-[#e4eefd] text-gray-800'
//           }`}>
//             <div className="max-w-7xl mx-auto">
//               <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
//                 {/* Left Section: Verification Process - Modern Card Design */}
//                 <div className="w-full lg:w-1/2 animate-slideInLeft">
//                   <div className={`rounded-2xl p-8 shadow-xl ${
//                     darkMode ? 'bg-gray-800/70 backdrop-blur-sm' : 'bg-white/90 backdrop-blur-sm'
//                   }`}>
//                     <div className="flex items-center justify-center mb-8">
//                       <span className={`px-6 py-2 rounded-full text-lg font-medium ${
//                         darkMode ? 'bg-gradient-to-r from-purple-600 to-pink-600' : 'bg-gradient-to-r from-purple-600 to-indigo-600'
//                       } text-white`}>
//                         Verification Process
//                       </span>
//                     </div>
...
//                         <div
//                           key={index}
//                           className={`rounded-xl shadow-md p-4 flex items-center gap-4 transition-all duration-300 transform hover:translate-x-2 ${
//                             darkMode 
//                               ? 'bg-gray-900/70 hover:bg-gray-900/90 border border-gray-700/30' 
//                               : 'bg-gradient-to-r from-white to-purple-50 hover:from-white hover:to-purple-100 border border-purple-100'
//                           } animate-slideInLeft`}
//                           style={{ animationDelay: `${index * 0.15}s` }}
//                         >
//                           <div className="flex-shrink-0">
//                             <span className={`flex items-center justify-center w-10 h-10 rounded-full ${
//                               darkMode ? 'bg-gradient-to-br from-purple-600 to-pink-600' : 'bg-gradient-to-br from-purple-600 to-indigo-600'
//                             } text-white font-bold text-lg shadow-lg`}>{index + 1}</span>
//                           </div>
//                           <span className="text-base sm:text-lg">{item}</span>
//                         </div>
//                       ))}
...
//                       <a href="/coming-soon">
//                         <button className={`px-8 py-3 rounded-full shadow-lg font-medium transition-all duration-300 transform hover:scale-105 ${
//                           darkMode 
//                             ? 'bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700' 
//                             : 'bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700'
//                         } text-white animate-pulseButton`}>
//                           Get Started Now
//                         </button>
//                       </a>
//                     </div>
...
//                 <div className="w-full lg:w-1/2 flex flex-col items-center justify-center animate-slideInRight">
//                   <div className="relative mb-8">
//                     <div className={`absolute -inset-4 rounded-full blur-lg opacity-50 ${
//                       darkMode ? 'bg-purple-500' : 'bg-purple-300'
//                     }`}></div>
//                     <img
//                       src={phoneImage}
//                       alt="Phone Verification"
//                       className="relative z-10 max-h-[350px] object-contain drop-shadow-2xl transform hover:scale-105 transition-transform duration-500"
//                     />
//                   </div>
                  
//                   <div className={`rounded-2xl p-6 sm:p-8 shadow-xl w-full max-w-md ${
//                     darkMode ? 'bg-gray-800/70 backdrop-blur-sm' : 'bg-white/90 backdrop-blur-sm'
//                   }`}>
//                     <h4 className={`text-xl font-semibold mb-4 border-l-4 ${
//                       darkMode ? 'border-purple-500' : 'border-purple-600'
//                     } pl-4`}>Why Choose Our Non-VOIP Numbers?</h4>
                    
//                     <p className="text-base leading-relaxed mb-6">
//                       Our genuine Non-VOIP numbers ensure reliable verification for all major platforms and services. With instant delivery and 24/7 support, we guarantee successful verification every time. Perfect for social media, payment
//                       platforms, and messaging apps.
//                     </p>
                    
//                     <div className="flex flex-wrap gap-3">
//                       {['100% Success Rate', 'Instant Delivery', 'Major Services Supported', '24/7 Support', 'Cost-Effective'].map((tag, index) => (
//                         <span 
//                           key={index}
//                           className={`text-sm px-3 py-1.5 rounded-full ${
//                             darkMode 
//                               ? 'bg-gray-700 text-purple-300 border border-purple-500/30' 
